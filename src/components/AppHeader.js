...
import { useSelector } from "react-redux"; // ile mağazadan bşey seçeceğim: başlık appTitle

const AppHeader = (props) => {
  //const appTitle = "afdfsgsfsdf";
  const displayFavorites = true;

  const { appTitle } = useSelector((state) => state); // tüm stora dan apptitle datasını select etti burda ve gidip h2 de yazdırdı.
